...
static ssize_t	ft_word_counter(const char *s, char set)
{
	ssize_t	counter;
	ssize_t	i;
...
static ssize_t	let_count(char *str, char set, ssize_t *index)
{
	ssize_t	j;
...
static char	*ft_word_split(char	*newstr, char *str, char set, ssize_t *index)
{
	ssize_t	j;
